package com.eduardo.loginwebappdemo.config.oauth2.service;

import com.eduardo.loginwebappdemo.config.oauth2.user.OAuth2UserInfo;
import com.eduardo.loginwebappdemo.config.oauth2.user.OAuth2UserInfoFactory;
